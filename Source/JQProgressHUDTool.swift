...
open class JQProgressHUDTool: NSObject {
    ...
    public class func jq_showToast(view: UIView? = UIApplication.shared.windows.last, msg: String? = "",duration: TimeInterval? = 3.0) {
    ...
    public class func jq_hideHUD(view: UIView? = UIApplication.shared.windows.last, animation: Bool? = false) {
